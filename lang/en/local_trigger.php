...
$string['addingitem'] = 'Adding a new webhook';
$string['editingitem'] = 'Editing a Webhook';
$string['createaitem'] = 'Create a webhook';
$string['itemtitle'] = 'Webhook Title';
$string['itemcontents'] = 'Webhook Text';
$string['saveitem'] = 'Save Webhook';
$string['itemname'] = 'Webhook Name';
$string['actions'] = 'Actions';
$string['edititem'] = 'Edit webhook';
$string['previewitem'] = 'Preview webhook';
$string['deleteitem'] = 'Delete webhook';
$string['confirmitemdelete'] = 'Are you sure you want to <i>DELETE</i> webhook? : {$a}';
$string['confirmitemdeletetitle'] = 'Really delete webhook?';
$string['noitems'] = 'There are no webhooks currently';
$string['additem'] = 'Add Webhook';
