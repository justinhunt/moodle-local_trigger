...
$string['customactions_explanation'] = 'Custom actions allow you to register API calls that can called by calling the local_trigger_custom_action API. This can be useful when you want to trigger an action in a 3rd party plugin, or a core API that is not included by default in the local_trigger web services declaration.';
